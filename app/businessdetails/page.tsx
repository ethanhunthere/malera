      ...
      <Container className="max-w-[720px]">
        ...
        <section className="mb-14">
          ...
          <div className="text-white/50 text-sm sm:text-base leading-relaxed space-y-3">
            ...
            <p>
              Every integration is documented — what it connects to, how the connection works, what data flows in each direction, and what to do if something breaks. Your team should never have to reverse-engineer an integration to understand what it does.
            </p>
          </div>
        </section>
        ...
        <section className="mb-14">
          ...
          <div className="text-white/50 text-sm sm:text-base leading-relaxed space-y-3">
            ...
            <p>
              Many Business engagements transition into an ongoing arrangement after launch — new features, performance improvements, scaling adjustments, maintenance. We can structure this as a monthly retainer or on a per-project basis depending on what makes sense for your situation.
            </p>
          </div>
        </section>
        ...
        <section className="mb-14">
          ...
          <div className="text-white/50 text-sm sm:text-base leading-relaxed space-y-3">
            ...
            <p>
              We also document the integrations — what is connected, how the connection works, and what to do if something breaks. The goal is that your team, or another development team, can take over the product with a complete understanding of how it works.
            </p>
          </div>
        </section>
