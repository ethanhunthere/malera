      ...
      <Container className="max-w-[720px]">
        ...
        <section className="mb-14">
          ...
          <div className="text-white/50 text-sm sm:text-base leading-relaxed space-y-3">
            <p>
              The Pro plan covers up to fifteen pages. At this scale the site needs a proper information architecture — how pages relate to each other, how users navigate between them, and how the structure supports both user experience and search engine crawling.
            </p>
            <p>
        ...
        <section className="mb-14">
          ...
          <div className="text-white/50 text-sm sm:text-base leading-relaxed space-y-3">
            <p>
              We build the site with a CMS so you can update content yourself without touching code. The choice of CMS depends on your needs. For most Pro projects we use a headless CMS — content is managed in a clean admin interface and delivered to the site via API. This keeps the site fast and gives you full control over text, images, and page structure.
            </p>
            <p>
        ...
        <section className="mb-14">
          ...
          <div className="text-white/50 text-sm sm:text-base leading-relaxed space-y-3">
            ...
            <p>
              The principle is restraint. Animation should feel purposeful, not decorative. Every motion decision is tied to a user need — guiding attention, providing feedback, or making spatial relationships clear. Nothing moves just because it can.
            </p>
          </div>
        </section>
        ...
        <section className="mb-14">
          ...
          <div className="text-white/50 text-sm sm:text-base leading-relaxed space-y-3">
            <p>
              We set up analytics properly from day one. Standard page view tracking across all pages. Event tracking for the actions that matter to your business — form submissions, button clicks, outbound link clicks, scroll depth on key pages. We configure the tracking so the data is clean and actionable from the start.
            </p>
            <p>
        ...
        <section className="mb-14">
          ...
          <div className="text-white/50 text-sm sm:text-base leading-relaxed space-y-3">
            ...
            <p>
              Two rounds gives proper space to refine the work without dragging the project out. The first round typically covers structural and layout adjustments. The second round is for finer details — typography tweaks, spacing adjustments, copy revisions. Change requests beyond the original scope are discussed and quoted separately.
            </p>
          </div>
        </section>
        ...
        <section className="mb-14">
          ...
          <div className="text-white/50 text-sm sm:text-base leading-relaxed space-y-3">
            ...
            <p>
              For ongoing work — content updates, new pages, feature additions, performance monitoring — we can structure a maintenance arrangement. Many Pro clients continue working with us on a retainer basis after the initial build.
            </p>
          </div>
        </section>
        ...
        <section className="mb-14">
          ...
          <div className="text-white/50 text-sm sm:text-base leading-relaxed space-y-3">
            <p>
              A Pro project typically takes four to six weeks. Week one is discovery and architecture — we map out the full site structure and CMS content model. Weeks two and three are design and development. Week four is your first revision round. Week five is the second revision and final polish. Week six is deployment, testing, and handover.
            </p>
            <p>
