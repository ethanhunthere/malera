        ...
        <div className="flex flex-col gap-3 sm:gap-4 items-center">
          {SERVICES.map((svc, idx) => {
            ...
            <div
              ...
              className="w-full group relative z-10 flex items-center gap-3 sm:gap-5 min-[3000px]:gap-8 min-[5000px]:gap-10 px-3 sm:px-6 min-[3000px]:px-10 min-[5000px]:px-12 py-3 sm:py-5 min-[3000px]:py-8 min-[5000px]:py-10 cursor-pointer rounded-2xl min-[3000px]:rounded-3xl glass-card-gold glass-card-gold-hover services-card-no-line"
            >
              {/* Content */}
