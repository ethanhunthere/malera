    ...
    return (
      <div className="relative glass-card-gold bg-black/[0.02] rounded-2xl p-6 sm:p-8 md:p-10 xl:p-12 2xl:p-14 min-[3000px]:p-20 min-[5000px]:p-28 overflow-hidden h-full flex flex-col items-center justify-center text-center !ring-1 !ring-gold/35 !shadow-[0_0_30px_rgba(201,168,76,0.08),0_0_60px_rgba(201,168,76,0.03)]">
        ...
        <div className="absolute top-0 left-0 w-8 sm:w-12 h-8 sm:h-12 min-[3000px]:w-16 min-[3000px]:h-16 overflow-hidden opacity-50 transition-opacity duration-700">
          ...
          <div className="absolute top-0 left-0 h-px w-full bg-gradient-to-r from-gold/70 via-gold/35 to-transparent" />
        </div>
        ...
        <div className="absolute bottom-0 right-0 w-8 sm:w-12 h-8 sm:h-12 min-[3000px]:w-16 min-[3000px]:h-16 overflow-hidden opacity-50 transition-opacity duration-700">
          <div className="absolute bottom-0 right-0 w-px h-full bg-gradient-to-t from-gold/70 via-gold/35 to-transparent" />
          <div className="absolute bottom-0 right-0 h-px w-full bg-gradient-to-l from-gold/70 via-gold/35 to-transparent" />
        </div>

        <CheckCircle2 className="text-gold w-12 h-12 sm:w-16 sm:h-16 2xl:w-20 2xl:h-20 min-[3000px]:w-28 min-[3000px]:h-28 min-[5000px]:w-36 min-[5000px]:h-36 mb-4 sm:mb-6 min-[3000px]:mb-10" strokeWidth={1.5} />
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 sm:px-6 sm:py-3 min-[3000px]:px-10 min-[3000px]:py-5 min-[5000px]:px-14 min-[5000px]:py-7 rounded-full bg-white text-black text-xs sm:text-sm 2xl:text-base min-[3000px]:text-xl min-[5000px]:text-2xl font-semibold
            hover:bg-gold hover:text-black hover:gap-3 hover:shadow-[0_4px_32px_rgba(201,168,76,0.3)]
  ...
  return (
    <div className="relative glass-card-gold bg-black/[0.02] rounded-2xl p-6 sm:p-8 md:p-10 xl:p-12 2xl:p-14 min-[3000px]:p-20 min-[5000px]:p-28 overflow-hidden h-full flex flex-col !ring-1 !ring-gold/35 !shadow-[0_0_30px_rgba(201,168,76,0.08),0_0_60px_rgba(201,168,76,0.03)]">
      ...
      <div className="flex items-center gap-3 sm:gap-4 min-[3000px]:gap-6 mb-5 sm:mb-8 min-[3000px]:mb-12">
        <div className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 2xl:w-14 2xl:h-14 min-[3000px]:w-20 min-[3000px]:h-20 min-[5000px]:w-24 min-[5000px]:h-24 rounded-2xl min-[3000px]:rounded-3xl bg-gold/10 ring-1 ring-gold/25 shadow-[0_0_10px_rgba(201,168,76,0.15)]">
          <Mail className="text-gold w-5 h-5 sm:w-6 sm:h-6 2xl:w-7 2xl:h-7 min-[3000px]:w-10 min-[3000px]:h-10 min-[5000px]:w-12 min-[5000px]:h-12" strokeWidth={1.5} />
        </div>
        <div>
